...
heroText: Chenf's blog
tagline: 个人技术博客，温故而知新，可以为师矣。学而不思则罔，思而不学则殆。
# actionText: 立刻进入 →
# actionLink: /web/
...
features: # 可选的
  - title: 前端
    details: JavaScript、ES6、Vue框架、html(5)/css(3)页面等前端技术
    link: /web/ # 可选
    imgUrl: /img/web.png # 可选
  - title: 开发
    details: Golang、Python、Java、C/C++、Shell，后端开发、脚本语言等相关技术
    link: /categories/?category=开发
    imgUrl: /img/ui.png
  - title: 技术
    details: 技术文档、教程、工具、技巧、经验总结等文章
    link: /technology/
